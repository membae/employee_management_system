...
id_lable=customtkinter.CTkLabel(app,font=font1,text="ID",text_color="#fff",bg_color="#161C25")
id_lable.place(x=20,y=20)
...
name_lable=customtkinter.CTkLabel(app,font=font1,text="NAME",text_color="#fff",bg_color="#161C25")
name_lable.place(x=20,y=80)
